...
public class SettingsActivity extends AppCompatActivity{
    ...
    public static class QuakePreferenceFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener{
        ...
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.quake_settings_main);

            Preference minMagnitude = findPreference(getString(R.string.f3_settings_min_magnitude_key));
            bindPreferenceSummaryToValue(minMagnitude);

            Preference orderBy = findPreference(getString(R.string.f3_settings_order_by_key));
